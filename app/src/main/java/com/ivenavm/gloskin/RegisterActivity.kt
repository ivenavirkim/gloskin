...
class RegisterActivity : AppCompatActivity() {
    ...
    lateinit var userDBHelper2: DataHelper2
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userDBHelper2 = DataHelper2(this)
    }
    fun registerme(view: View){
        ...
        var cekuser = userDBHelper2.cekUser(iemail)
        var status = "Gagal"
        if (cekuser =="0") {
            userDBHelper2.registerUser(iemail, ipassword, ifullname, ijenkal, ialamat)
            status = "Sukses"
